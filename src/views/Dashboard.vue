<template>
  <div class="flex min-h-screen">
    <!-- Sidebar -->
    <Sidebar ref="sidebarRef" @page-change="setActivePage" @logout="handleLogout" />
...
const handleLogout = () => {
  // Handle logout logic, perhaps redirect to auth
  router.push('/auth')
}
</script>
...
.pulse::before {
  ...
  background: #D4820A; animation: pulse-ring 1.4s ease-out infinite;
}
</style>